...
const ENERGY_GLOW: Record<EnergyTier, string> = {
  high: 'rgba(79,174,111,0.4)',
  mid: 'rgba(201,162,75,0.3)',
  low: 'rgba(194,59,59,0.3)'
}
...
const CompanionAvatar: React.FC<CompanionAvatarProps> = ({ mood, energyTier }) => {
  ...
  return (
    ...
    >
      ...
      {mood === 'happy' && (
        <path d="M32 40 Q40 48 48 40" fill="none" stroke="#111" strokeWidth="2" />
      )}
      {mood === 'worried' && (
        <path d="M32 42 Q40 36 48 42" fill="none" stroke="#111" strokeWidth="2" />
      )}
